...
export class AuthService {
  constructor(
    private baseURLIAM: string,
    private baseURLMathCompetition: string
  ) {}
  ...
  register({
    ...
    school,
    klass,
  }: { email: string; password: string; name: string; school: string; klass: MemberClass }): Observable<void> {
